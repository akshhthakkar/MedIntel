...
const ResetPasswordPage = () => {
  ...
  const { token: authToken, login } = useAuth(); // getting global setToken logic indirectly through login might be tricky if not exported, so we will just navigate to /login and rely on the fact that the API returns the token and we can save it, or just force them to log in. In MedIntel context handles localstorage so let's redirect to login for a fresh flow.
